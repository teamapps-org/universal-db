...
public class InitMessageResponse implements ClusterMessage {
	...
	public InitMessageResponse(int nodeId, long lastTransactionId, long currentTransactionId, long transactionCount, Schema schema, ClusterOperationMode clusterOperationMode, ClusterNodeRole currentType, ClusterNodeRole preferredType) throws IOException {
		this.nodeId = nodeId;
	...
	public InitMessageResponse(byte[] data) throws IOException {
		this.data = data;
		ByteBuffer buffer = ByteBuffer.wrap(data);
	...
	public MessageType getType() {
		return MessageType.INITIAL_MESSAGE_RESPONSE;
	}
