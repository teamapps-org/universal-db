...
public class SynchronizeTransactionsRequest implements ClusterMessage {
	...
	public SynchronizeTransactionsRequest(long requestStartId, long requestEndId, long lastTransactionId, long currentTransactionId, long transactionCount) {
	...
	public SynchronizeTransactionsRequest(byte[] data) {
		this.data = data;
		ByteBuffer buffer = ByteBuffer.wrap(data);
	...
	public MessageType getType() {
		return MessageType.SYNCHRONIZE_TRANSACTIONS_REQUEST;
	}
