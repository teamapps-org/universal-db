...
public class ConnectToHeadRequest implements ClusterMessage {
	...
	public ConnectToHeadRequest(long lastTransactionId, long currentTransactionId, long transactionCount) {
	...
	public ConnectToHeadRequest(byte[] data) {
		this.data = data;
		ByteBuffer buffer = ByteBuffer.wrap(data);
	...
	public MessageType getType() {
		return MessageType.CONNECT_TO_HEAD_REQUEST;
	}
